...
public final class CropNeutralSentiment {

    static Logger logger = Logger.getLogger(CropNeutralSentiment.class);
...
//                    String outpout = "," + stringArray[1] + "," + stringArray[2] + "," + stringArray[3] + "," + stringArray[4] + "," + stringArray[5] + "," + stringArray[6] + "," + stemmed;
    ...
    public static void main(String[] args) throws Exception {
        ...
        Job job = new Job(configuration, "CropNeutralSentiment");

        job.setJarByClass(CropNeutralSentiment.class);
