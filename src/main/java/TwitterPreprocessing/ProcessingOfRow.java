 ...
 */
public class ProcessingOfRow {
    static Logger logger = Logger.getLogger(ProcessingOfRow.class);

//    public static final HashSet<String> happyEmoticons = new HappyEmoticons().getHappyArray();
    public static final HashSet<String> happyEmoticons = new HappyEmoticonsShortList().getHappyArray();
//    public static final HashSet<String> sadEmoticons = new SadEmoticons().getSadArray();
    public static final HashSet<String> sadEmoticons = new SadEmoticonsShortList().getSadArray();
    ...
    public static String clearWhitespace(String preprocessed) throws IOException {
    ...
    public static String removeStopwords(String preprocessed) throws IOException {
        ...
        public static String[] tagNegationsAdjective(String s1, String s2) throws IOException {
    ...
    public static String negationsBasedOnAdj(String preprocessed) throws IOException {
    ...
    public static String[] tagNegationsVerbs(String s1, String s2) throws IOException {
    ...
    public static String negationsBasedOnVerbs(String preprocessed) throws IOException {
    ...
    public static String slangProcess(String preprocessed) {
    ...
    public static String removeNonAscii(final String preprocessed) {
//
    ...
    public static EmoticonResult happyCounting(String s) {

        final EmoticonResult emoticonResult = new EmoticonResult();
        for(String item : happyEmoticons){
            if (s.contains(item)){
                emoticonResult.increaseCounter();
                emoticonResult.setEmoticons(item);
            }
        }
        return emoticonResult;
    }

    public static EmoticonResult sadCounting(String s) {
        final EmoticonResult emoticonResult = new EmoticonResult();
        for(String item : sadEmoticons){
            if (s.contains(item)){
                emoticonResult.increaseCounter();
                emoticonResult.setEmoticons(item);
            }
